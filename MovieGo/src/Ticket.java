...
public class Ticket extends javax.swing.JFrame {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ResultSet rs = Select.getData("SELECT * FROM biletler");
    ...
    private void tableMovieMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMovieMouseClicked
        ...
        int response = JOptionPane.showConfirmDialog(null,"Do you really want to cancel this ticket?", "Select", JOptionPane.YES_NO_OPTION);
